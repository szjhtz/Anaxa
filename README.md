...
3. **配置工具 / 学术密钥**（可选）：如需网页搜索、Google AI Studio 科研文生图或学术检索增强，填入 Tavily / Jina / Google AI Studio / OpenAlex / Semantic Scholar 的 API Key
...
- 工具 / 文生图 / 学术 API Key：`TAVILY_API_KEY`、`JINA_API_KEY`、`GEMINI_API_KEY`、`GOOGLE_API_KEY`、`GITHUB_TOKEN`、`OPENALEX_API_KEY`、`SEMANTIC_SCHOLAR_API_KEY`
